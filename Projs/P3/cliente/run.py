...
@app.command(name="backup-google-drive")
def backup_google_drive():
    """Faz backup do cofre no Google Drive."""
    cliente.backup_google_drive()

@app.command(name="get-backup-google-drive")
def get_backup_google_drive(filename: str):
    """Faz backup do cofre no Google Drive."""
    cliente.get_backup_google_drive(filename)
